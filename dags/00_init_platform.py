...
def init_platform():
    ...
    def create_bronze_layout(bucket_names: list[str]) -> list[str]:
        ...
        prefixes = [
            ...
            f"{TRUSTED_BUCKET}:structured/lastfm/rejected/",
            f"{TRUSTED_BUCKET}:structured/musicbrainz/rejected/",
            f"{TRUSTED_BUCKET}:structured/reccobeats/rejected/",
            ...
            f"{TRUSTED_BUCKET}:unstructured/images/rejected/",
            f"{TRUSTED_BUCKET}:metadata/structured/lastfm/",
            f"{TRUSTED_BUCKET}:metadata/structured/musicbrainz/",
            f"{TRUSTED_BUCKET}:metadata/structured/reccobeats/",
            f"{TRUSTED_BUCKET}:metadata/semi_structured/trends/",
            f"{TRUSTED_BUCKET}:metadata/recommender/feedback/",
            f"{TRUSTED_BUCKET}:metadata/unstructured/images/",
            ...
            f"{CONSUMPTION_BUCKET}:recommendations/feedback_events_delta/",
            f"{CONSUMPTION_BUCKET}:recommendations/feedback_summary_delta/",
            f"{CONSUMPTION_BUCKET}:recommendations/recommendation_outcomes_delta/",
